...
bottom_right_corner = map.get_coordinates(
...
# For debugging
print(
    f"{round(top_left_corner[0][0])}, {round(top_left_corner[0][1])} ------ {round(top_right_corner[0][0])}, {round(top_right_corner[0][1])}"
)
print(
...
x_lims = [
    round(bottom_left_corner[0][0]) - round(origin[0][0]),
    round(top_right_corner[0][0]) - round(origin[0][0]),
]
y_lims = [
    round(bottom_left_corner[0][1]) - round(origin[0][1]),
    round(top_right_corner[0][1]) - round(origin[0][1]),
]
